...
// Adresse du module OrangeRX avec ULRS modifié 
#define UltimateLRS_ADDR  0x11
#define HeadTracker 1
#if HeadTracker == 1
int headtrackerchannel[6] ;
short datareceived ;
#endif
...
unsigned long CARRIER_FREQUENCY = 434000; // Frequence nominale
unsigned char HOPPING_STEP_SIZE = 6;    //espace entre deux canaux X 10kHz  -> 60kHz

#define FREQUENCY_HOPPING 1

static unsigned char hop_list[3] = { 45, 50, 55}; //Numero du canal a multiplier par HOPPING_STEP_SIZE + CARRIER_FREQUENCY -> 2.7MHz,3Mhz,3.3Mhz -> 436.7,437,437.3
...
static unsigned char RF_Header[4] = {'C', 'O', 'R', 'K'};
